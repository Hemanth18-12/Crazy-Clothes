...
export default function CustomizePage() {
  const { customizableProducts, loading: productsLoading } = useProducts();
  ...
  return (
    <>
      <CartDrawer />
      <section id="customize" className="page-section" style={{ minHeight: "80vh", paddingTop: "8rem" }}>
        <div className="container">
          ...
          {!currentUser ? (
            /* Auth Gate Card */
            <div id="customize-auth-gate" style={{ display: 'block', textAlign: 'center', padding: '3rem 1rem' }}>
              <div style={{
                ...
                <p style={{ fontFamily: 'var(--font-mono)', fontSize: '0.82rem', color: 'var(--color-text-secondary)', marginBottom: '1.75rem', lineHeight: '1.6' }}>
                  Login to access the customization flow and start customizing.
                </p>
